...
**Onde:** `src/menu.cpp:29`  ·  **Declarada em:** `src/menu.h:12`  ·  **Módulo:** menu
...
> **Corrigido em 10/09** (item C4): a tela dizia "Maio de 2026"; agora diz **Setembro de 2026**,
> o mês da entrega, igual ao cabeçalho do arquivo.
